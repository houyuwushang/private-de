...
class Measurements:
    ...
    sequential_transcript: dict[str, Any] | None = None
    ...
    def to_public_dict(self) -> dict:
        ...
        if self.sequential_transcript is not None:
            payload["sequential_transcript"] = self.sequential_transcript
...
def measurements_from_public_dict(data: dict[str, Any]) -> Measurements:
    ...
    return Measurements(
        ...
        sequential_transcript=(
            dict(data["sequential_transcript"])
            if data.get("sequential_transcript") is not None
            else None
        ),
